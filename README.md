...
Scout - полнотекстовый поиск по моделям Eloquent
...
laravel/scout Полнотекстовый поиск в БД
...
Полнотекстовый поиск в БД реализован с применением пакета Scout. В настоящее время используется database engine. Индексы добавлены ко всем ресурсам.
...
Планы развития
Тестирование — Unit и Feature тесты для политик и контроллеров
